...
const LESSON_STEP_COPY = {
  en: {
    ...
    introScenario: {
      withPlan: 'With a plan',
      withoutPlan: 'Without a plan',
      processRail: 'Process rail',
      stableDecisions: 'Stable decisions',
      reactiveDecisions: 'Reactive decisions',
      missingSuffix: ' missing',
      premature: 'Premature',
      tapExecution: 'Tap execution to see outcome',
      downstreamImpact: 'Downstream steps weaken; execution becomes premature.',
      stableOutcome: 'Stable outcome',
      reactiveOutcome: 'Reactive outcome',
      stableCaption: 'Clarity before execution keeps outcomes steadier.',
      reactiveCaption: 'Skipping steps makes outcomes more reactive.',
      keyInsightFallback:
  ...
  nl: {
    ...
    messages: {
      ...
      reflectionPlaceholder: 'Schrijf een korte reflectie',
    ...
    introScenario: {
      withPlan: 'Met een plan',
      withoutPlan: 'Zonder plan',
      processRail: 'Proceslijn',
      stableDecisions: 'Stabiele beslissingen',
      reactiveDecisions: 'Reactieve beslissingen',
      missingSuffix: ' ontbreekt',
      premature: 'Te vroeg',
      tapExecution: 'Tik op uitvoering om de uitkomst te zien',
      downstreamImpact: 'Volgende stappen verzwakken; uitvoering wordt te vroeg.',
      stableOutcome: 'Stabiele uitkomst',
      reactiveOutcome: 'Reactieve uitkomst',
      stableCaption: 'Duidelijkheid voor uitvoering houdt uitkomsten stabieler.',
      reactiveCaption: 'Stappen overslaan maakt uitkomsten reactiever.',
      keyInsightFallback:
